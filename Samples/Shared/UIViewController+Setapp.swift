...
extension UIViewController {
    ...
    var optionsMenu: UIMenu {
        UIMenu(title: targetName, children: [
            UIAction(title: "Request Auth Code", image: UIImage(systemName: "curlybraces"), handler: { [weak self] _ in
...
extension UIViewController {
    @IBAction func presentAuthCodeAlert(_ sender: UIButton? = nil) {
        let alert = UIAlertController(
            ...
            message: "Authorization code is used to access the Setapp server using Vendor API.",
