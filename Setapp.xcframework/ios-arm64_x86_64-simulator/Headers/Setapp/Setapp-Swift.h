...
/// you have one.
/// \param defaultConfiguration A Setapp configuration to start the framework with. The default value is <code>SetappConfiguration.default</code>.
///
/// \param setappMobileConfiguration A Setapp configuration to start the framework with for distribution via Setapp Mobile.
///
